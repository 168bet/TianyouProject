                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">充值排行</span>
                            ...
                            <div class="widget-body" style="overflow-x: scroll;">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="tb_pay">
                                    <thead> 
                                    <tr> 
                                        <th field="rank" data-switchable="false">排名</th>

                                        <th field="newuser" data-switchable="false">用户ID</th>

                                        <th field="newuser" data-switchable="false">用户昵称</th>

                                        <th field="newuser" data-switchable="false">城堡等级</th>

                                        <th field="ordernum" data-switchable="false">充值金额</th>
...
<script>
    $(document).ready(function () {
        ...
        $(".sidebar-menu .menu-li:eq(7) .submenu li:eq(6)").addClass("active");
        ...
        var oTable = $('#tb_pay').dataTable({
            ...
            "bFilter": false,
            "aoColumns": [
                {"mData": 'rank'},{"mData": 'uid'},{"mData": 'name'},{"mData": 'level'},  {"mData": 'paymoney'}
            ],
            "sAjaxSource": "slgpay/querylist",
