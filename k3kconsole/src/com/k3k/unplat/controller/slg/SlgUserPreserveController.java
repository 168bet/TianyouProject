...
import com.k3k.unplat.service.slg.SlgUserPreserveService;
 ...
 */
@Controller
@RequestMapping(value = "slguserpreserve")
public class SlgUserPreserveController {
    private static final Log LOGGER = LogFactory.getLog(SlgUserPreserveController.class);
    private static final SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd");

    @Autowired
    private SlgUserPreserveService slgUserPreserveService;

    @RequestMapping(value = "slguserpreserve", method = RequestMethod.GET)
    public ModelAndView sjlUserPreserve() {
        /**
         * 查看SLG用户留存，可以根据相应条件筛选
         */
        ModelAndView mav = new ModelAndView();
        mav.setViewName("admin/SLG/userpreserve");
        return mav;
    }

    @RequestMapping(value = "query", method = RequestMethod.POST)
    public void query(Page<SlgUserPreserve> page, SlgUserPreserve filter, HttpServletRequest request, HttpServletResponse response) {
        ...
        page = slgUserPreserveService.findPage(page, filter);
