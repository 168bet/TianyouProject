 ...
 *
 */
public class CmdUpdateTypeUrl extends PackerAbstract
{
	...
	public byte[] getByteArrayData()
	{
		 ...
		 */
		addHeader(PACK_SIZE, 2, Constants.S_MAIN_TYPE_OP, Constants.S_SUB_UP_TYPE_URL);
		addInt(this.unionId);
		addInt(this.typeId);
		addInt(this.sort);
