 ...
 *
 */
public class CmdUpdateKind extends PackerAbstract
{
	...
	public byte[] getByteArrayData()
	{
		 ...
		 */
		addHeader(PACK_SIZE, 2, Constants.S_MAIN_KIND_OP, Constants.S_SUB_UP_KIND);
		addInt(this.unionId);
		addInt(this.typeId);
		addInt(this.sort);
		addInt(this.kindId);
