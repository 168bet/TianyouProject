<<<<<<< HEAD:multi_channel/multi_channel_library/src/com/tianyou/channel/business/JinliSdkService.java
...
public class JinliSdlService extends BaseSdkService{
	...
	public void doLogin() {
		GamePlatform.loginAccount(mActivity, true, new LoginListener() {
			...
			public void onSuccess(AccountInfo accountInfo) {
				...
				String session = accountInfo.mToken;
				Log.d("TAG", "playerid= "+accountInfo.mPlayerId);
				checkJiLiLogin(sid, session,accountInfo.mPlayerId);
			}
	...
	private void checkJiLiLogin(String uid, String session,String playerid) {
    	String gameId = mChannelInfo.getGameId();
		Map<String, String> param = new HashMap<String, String>();
		param.put("uid", uid);
		param.put("session", session);
...
>>>>>>> 41a2fc61cf7c9eb020c733a649e01e280dc50348:multi_channel/multi_channel_library/src/com/tianyou/channel/business/JinliSdlService.java
