...
public class Constant {
	...
	public static final String PARAM_STOREID = "cpId";// "storeId";// 商户id
	public static final String PARAM_STOREORDER = "cpOrderNumber";// "storeOrder";//
																	// 商户自定义的订单号
																	// 商户自定义，最长
																	// 64
																	// 位字母、数字和下划线组成
	public static final String PARAM_NOTIFYURL = "notifyUrl";// 异步通知urL
	public static final String PARAM_EXTINFO = "extInfo"; // CP扩展参数，异步通知时会透传给CP服务器
	...
	public static final String RESPONE_SIGNATURE = "signature";// 签名信息
																// 对关键信息签名后得到的字符串
	public static final String RESPONE_VIVO_SIGNATURE = "accessKey";// "vivoSignature";//
																	// 签名信息
	public static final String RESPONE_RESP_CODE = "respCode";// 响应码
	public static final String RESPONE_RESP_MSG = "respMsg";// 响应信息

	public static final String RESPONE_VIVO_ORDER = "orderNumber";// "vivoOrder";//
																	// 交易流水号
																	// vivo订单号
	...
	public static String CONS_UUID = null;
...
//	 public static final String APP_ID = "1007"; // com.example.paydemo
	...
	public static final String VIVO_STORE_ID = "20140304162939412429";
	public static final String VIVO_SIGN_KEY = "969E6D5F1C1A1E8C5E8FF17B15FC6938";
	public static final String VIVO_APP_ID = "4de4c7e0c5f0d62f7a189976d5d68825"; // com.tuomi.zznzh.vivo
}