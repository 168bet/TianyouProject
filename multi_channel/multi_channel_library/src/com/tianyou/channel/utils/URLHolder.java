...
//	public static String URL_BASE = "http://channel.tianyouxi.com"; // 国内正式地址
	public static String URL_BASE = "http://newchannel.tianyouxi.com/api/"; // 国内正式地址
	...
	//登录校验地址
	public static String CHECK_LOGIN_URL = "login/MemberLogin";
	public static String CHECK_LOGIN_URL_QIHOO = URL_BASE + "/login/UserCheck";
	//创建订单地址
	public static String CREATE_ORDER_URL = "Order/CreatOrder";
	//校验订单地址  
	public static String CHECK_ORDER_URL = "Order/SendOrder";
	//one store查单
	public static String URL_ONE_STORE = "OneStore/GetPayInfo";
	// google 查单
	...
	public static String UPLOAD_ROLE_INFO = "http://channel.tianyouxi.com/index.php/Roleinfo/PutRoleInfo";
}
