...
public class ChannelService extends BaseSdkService {
	...
	public void doUploadRoleInfo(RoleInfo roleInfo) {
		...
		VivoUnionSDK.reportRoleInfo(new VivoRoleInfo(roleInfo.getRoleId(), roleInfo.getRoleLevel(),
				roleInfo.getRoleName(), roleInfo.getServerId(), roleInfo.getServerName()));
	}

	@Override
	public void doChannelPay(PayParam payInfo, OrderinfoBean orderInfo) {
		super.doChannelPay(payInfo, orderInfo);
		VivoPayInfo vivoPayInfo = new VivoPayInfo(orderInfo.getProduct_name(), orderInfo.getProductDesc(),
				orderInfo.getMoNey(), orderInfo.getAccessKey(), mChannelInfo.getAppId(), orderInfo.getOrderNumber(),
				mLoginInfo.getChannelUserId());
