...
public class UserApi {
    ...
    private static void requestAddPlusFriends(final ResponseCallback<Boolean> callback, final String plusFriendIds) {
        KakaoTaskQueue.getInstance().addTask(new KakaoResultTask<Boolean>(callback) {
            ...
            public Boolean call() throws Exception {
                ...
                ResponseData result = networkTask.requestApi(new AddPlusFriendsRequest(plusFriendIds));
    ...
    public static UserResponse requestSignup(Map<String, String> properties) throws Exception {
        ...
        if (result.getHttpStatusCode() == HttpURLConnection.HTTP_OK) {
            String plusFriendIds = Session.getAppCache().getString(KEY_PLUS_FRIEND_ADD);
            if (plusFriendIds != null) {
                requestAddPlusFriends(new ResponseCallback<Boolean>() {
                    @Override
...
//                        Logger.d("requestAddPlusFriends Success");
                    }
                }, plusFriendIds);
