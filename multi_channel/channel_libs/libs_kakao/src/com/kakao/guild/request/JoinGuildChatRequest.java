...
public class JoinGuildChatRequest extends ApiRequest {
    ...
    public String getUrl() {
        String baseUrl = "https://" + GameServerProtocol.GAME_GUILD_API_AUTHORITY + GameServerProtocol.API_VERSION_2 + "/" + worldId + GameServerProtocol.GET_GUILDS_PATH;
        return baseUrl + "/" + guildId + GameServerProtocol.GET_REJOIN_PATH;
    }
}
