...
public class ApiResponse {
    ...
    protected ApiResponse(ResponseData responseData) throws ResponseBodyException, ApiResponseStatusError {
        if (responseData.getHttpStatusCode() != HttpURLConnection.HTTP_OK) {
            ...
            if (errResponseBody.has(StringSet.code)) {
                ...
                throw new ApiResponseStatusError(responseData.getHttpStatusCode(), errResponseBody.optString(StringSet.desc, ""), responseData.getHttpStatusCode());
            }
        }
    }
