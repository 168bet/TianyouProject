                            ...
                            <div class="widget-body" style="overflow-x: scroll;">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="tb_account">
                                    ...
                                    <tr> 
                                        ...
                                        <th field="activenum" data-visible="false">活跃账号数</th>

                                        <th field="newusernum" data-visible="false">新增用户数</th>
                                         
                                        <th field="usernum" data-visible="false">老用户数</th>
                                    </tr>
                                     
                                    </thead>
                                     
...
<script>
    $(document).ready(function () {
        ...
        $(".sidebar-menu .menu-li:eq(7) .submenu li:eq(0)").addClass("active");
        ...
        var oTable = $('#tb_account').dataTable({
            ...
            "bFilter": false,
            "aoColumns": [
                {"mData": 'day'}, {"mData": 'channel'}, {"mData": 'entry'}, {"mData": 'platform'}, {"mData": 'activenum'}, {"mData": 'newusernum'}, {"mData": 'usernum'}
            ],
            "sAjaxSource": "slgaccount/query",
