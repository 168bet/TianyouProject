                    ...
                    <form id="sform">
                        <div class="widget-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <label><strong>太守府等级</strong></label>
                                    <input name="buildinglevel" type="text" class="form-control" id="buildinglevel" placeholder="请输入数字"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4">
                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">用户流失</span>
                            ...
                            <div class="widget-body" style="overflow-x: scroll;">
                                <br>
                                <table class="table table-striped table-hover table-bordered" id="tb_userlose">
                                    <thead> 
                                    <tr> 
                                        <th field="day" data-switchable="false">日期</th>

                                        <th field="lognum" data-switchable="false">渠道</th>

                                        <th field="lognum" data-switchable="false">新增账号</th>

                                        <th field="regnum" data-switchable="false">次日流失</th>
                                         
                                        <th field="active2" data-switchable="false">3日流失</th>

                                        <th field="active3" data-visible="false">4日流失</th>

                                        <th field="active7" data-visible="false">5日流失</th>

                                        <th field="active7" data-visible="false">6日流失</th>

                                        <th field="active7" data-visible="false">7日流失</th>
...
<script>
    $(document).ready(function () {
        ...
        $(".sidebar-menu .menu-li:eq(7) .submenu li:eq(2)").addClass("active");
        ...
        var oTable = $('#tb_userlose').dataTable({
            "bServerSide": true,
            "sinfo": false,
            "bLengthChange": false,
            "iDisplayLength": 10,
            ...
            "bFilter": false,
            "aoColumns": [
                {"mData": 'date'}, {"mData": 'channel'}, {"mData": 'regnum'},{"mData": 'loserate2'},{"mData": 'loserate3'},{"mData": 'loserate4'},{"mData": 'loserate5'},{"mData": 'loserate6'},{"mData": 'loserate7'}
            ],
            "sAjaxSource": "slglose/query",
    ...
    function reload_dt() {
        $('#tb_userlose').DataTable().ajax.reload();
    }
