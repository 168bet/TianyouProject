 ...
 *
 */
public class CmdUpdateUnionConfig  extends PackerAbstract
{
	private int unionID;
	...
	public byte[] getByteArrayData()
	{
		 ...
		 */
		addHeader(PACK_SIZE, 2, Constants.S_MAIN_UNION_OP, Constants.S_SUB_UP_UNION);
		addInt(this.unionID);
