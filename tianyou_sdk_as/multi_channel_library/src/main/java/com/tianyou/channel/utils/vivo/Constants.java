...
public class Constants {
	...
	public static final String PAYMENT_ACTIVITY = "com.bbk.payment.PaymentActivity";//PaymentActionActivity";
	public static final String PAYMENT_ACTIVITY_DETAILS = "com.bbk.payment.TestPaymentActionActivity";	
