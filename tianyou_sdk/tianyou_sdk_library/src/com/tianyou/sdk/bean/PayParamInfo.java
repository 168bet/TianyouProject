...
public class PayParamInfo {
	...
	public String toString() {
		return "PayParamInfo [gameName=" + gameName + ", roleId=" + roleId
				+ ", serverId=" + serverId + ", serverName=" + serverName
				+ ", productId=" + productId + ", productName=" + productName
				+ ", customInfo=" + customInfo + ", sign=" + sign
				+ ", signType=" + signType + ", userName=" + userName
				+ ", money=" + money + ", payMoney=" + payMoney + ", orderId="
				+ orderId + ", SELLER=" + SELLER + ", PARTNER=" + PARTNER
