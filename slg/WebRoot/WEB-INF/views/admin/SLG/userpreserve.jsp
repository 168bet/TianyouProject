                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">用户留存</span>
                            ...
                            <div class="widget-body" style="overflow-x: scroll;">
                                <br>
                                <table class="table table-striped table-hover table-bordered" id="tb_userpreserve">
                                    <thead> 
                                    <tr> 
                                        ...
                                        <th field="lognum" data-switchable="false">入口</th>

                                        <th field="lognum" data-switchable="false">平台</th>

                                        <th field="lognum" data-switchable="false">登录账号</th>

                                        <th field="regnum" data-switchable="false">新增账号</th>
                                         
                                        <th field="active2" data-switchable="false">次日留存</th>

                                        <th field="active3" data-visible="false">三日留存</th>

                                        <th field="active7" data-visible="false">四日留存</th>

                                        <th field="active7" data-visible="false">五日留存</th>

                                        <th field="active7" data-visible="false">六日留存</th>

                                        <th field="active7" data-visible="false">七日留存</th>
...
<script>
    $(document).ready(function () {
        ...
        var oTable = $('#tb_userpreserve').dataTable({
            "bServerSide": true,
            "sinfo": false,
            "bLengthChange": false,
            "iDisplayLength": 10,
            ...
            "bFilter": false,
            "aoColumns": [
                {"mData": 'day'}, {"mData": 'channel'}, {"mData": 'entry'}, {"mData": 'platform'}, {"mData": 'lognum'}, {"mData": 'regnum'}, {"mData": 'rate2'}, {"mData": 'rate3'}, {"mData": 'rate4'},{"mData": 'rate5'},{"mData": 'rate6'},{"mData": 'rate7'}
            ],
            "sAjaxSource": "slguserpreserve/query",
    ...
    function reload_dt() {
        $('#tb_userpreserve').DataTable().ajax.reload();
    }
