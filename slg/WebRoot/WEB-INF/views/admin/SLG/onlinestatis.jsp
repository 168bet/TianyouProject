            ...
            <div class="page-body">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        <label><strong>选择日期</strong></label>
                                        <div class="input-group">
                                        <span class="input-group-addon">
                                        <i class="fa fa-calendar"></i></span>
                                            <input name="Date" class="form-control date-picker" placeholder="选择时间" id="date-picker" type="text" data-date-format="yyyy-mm-dd">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <div class="widget">
                            <div class="widget-header ">
                                <span class="widget-caption">在线统计</span>
                                <div class="widget-buttons">
                            ...
                            <div class="widget-body">
                                <br>
                                <table class="table table-striped table-hover table-bordered" id="tb_online">
                                    <thead>
                                    <tr>
                                        <th>时间</th>
                                        <th>在线人数</th>
...
<script>
    $(document).ready(function () {
        ...
        $(".sidebar-menu .menu-li:eq(7) .submenu li:eq(3)").addClass("active");
        ...
        var oTable = $('#tb_online').dataTable({
            "bServerSide": true,
            "bLengthChange": false,
            "iDisplayLength": 24,
            "bProcessing": true,
    ...
    function draw_charts(data) {
        ...
        var onlinenum = chart_data.map(function (o) {
            return o.onlinenum
        });

        var series = [{name: '在线用户', data: onlinenum}];
    ...
    function reload_dt() {
        $('#tb_online').DataTable().ajax.reload();
    }
